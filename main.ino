...
Adafruit_MQTT_Client mqtt(&client, MQTT_SERVER, MQTT_PORT, MQTT_USERNAME, MQTT_PASSWORD); 
 ...
 Notice MQTT paths for AIO follow the form usernamefeedsfeedname 
Adafruit_MQTT_Publish pi_led = Adafruit_MQTT_Publish(&mqtt, MQTT_USERNAME ledspi); 
 Setup a feed called 'esp8266_led' for subscribing to changes. 
Adafruit_MQTT_Subscribe esp8266_led = Adafruit_MQTT_Subscribe(&mqtt, MQTT_USERNAME ledsesp8266); 
 Sketch Code  
void MQTT_connect(); 
void setup() { 
 Serial.begin(115200); 
